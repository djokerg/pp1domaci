...
public class FormParamCorrect extends FormParam {

    private Type Type;
    private String paramName;
    private PossibleArrayDecl PossibleArrayDecl;

    public FormParamCorrect (Type Type, String paramName, PossibleArrayDecl PossibleArrayDecl) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormParamCorrect(\n");
