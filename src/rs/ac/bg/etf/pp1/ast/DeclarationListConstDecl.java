...
public class DeclarationListConstDecl extends DeclarationList {

    private DeclarationList DeclarationList;
    private ConstDecl ConstDecl;

    public DeclarationListConstDecl (DeclarationList DeclarationList, ConstDecl ConstDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationListConstDecl(\n");
