...
public class DesignatorHelperListDerived2 extends DesignatorHelperList {

    private DesignatorHelperList DesignatorHelperList;
    private Expr Expr;

    public DesignatorHelperListDerived2 (DesignatorHelperList DesignatorHelperList, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorHelperListDerived2(\n");
