...
public class StaticInitializerListDerived2 extends StaticInitializerList {

    private StaticInitializerList StaticInitializerList;
    private StaticInitializer StaticInitializer;

    public StaticInitializerListDerived2 (StaticInitializerList StaticInitializerList, StaticInitializer StaticInitializer) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StaticInitializerListDerived2(\n");
