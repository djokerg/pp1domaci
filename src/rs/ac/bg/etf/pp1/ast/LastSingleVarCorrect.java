...
public class LastSingleVarCorrect extends LastSingleVar {

    private String varName;
    private PossibleArrayDecl PossibleArrayDecl;

    public LastSingleVarCorrect (String varName, PossibleArrayDecl PossibleArrayDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("LastSingleVarCorrect(\n");
