...
public class MultipleVarDeclSingleVar extends MultipleVarDecl {

    private SingleVar SingleVar;

    public MultipleVarDeclSingleVar (SingleVar SingleVar) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleVarDeclSingleVar(\n");
