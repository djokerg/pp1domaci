...
public class DeclarationListVarDecl extends DeclarationList {

    private DeclarationList DeclarationList;
    private VarDecl VarDecl;

    public DeclarationListVarDecl (DeclarationList DeclarationList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationListVarDecl(\n");
