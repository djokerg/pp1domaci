...
public class StaticVarDeclListDerived1 extends StaticVarDeclList {

    private StaticVarDeclList StaticVarDeclList;
    private VarDecl VarDecl;

    public StaticVarDeclListDerived1 (StaticVarDeclList StaticVarDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StaticVarDeclListDerived1(\n");
