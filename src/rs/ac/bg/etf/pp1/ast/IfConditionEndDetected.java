...
public class IfConditionEndDetected implements SyntaxNode {
    ...
    public IfConditionEndDetected (IfStartDetected IfStartDetected, Condition Condition) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("IfConditionEndDetected(\n");
