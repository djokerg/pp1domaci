...
public class StaticInitializerSingle extends StaticInitializerList {

    private StaticInitializer StaticInitializer;

    public StaticInitializerSingle (StaticInitializer StaticInitializer) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StaticInitializerSingle(\n");
